<template>
  <div class="app-container">
    ...
    <el-table :data="rolesList" style="width: 100%;margin-top:30px;" border>
      ...
      <el-table-column align="center" label="接口路径">
        <template slot-scope="scope">
    ...
    <el-dialog :visible.sync="dialogVisible" :title="dialogType==='edit'?'编辑权限':'新增权限'">
      <el-form :model="role" label-width="80px" label-position="left">
        ...
        <el-form-item label="标识">
          <el-input v-model="role.name" placeholder="唯一标识" />
        </el-form-item>
        <el-form-item label="请求路径">
          <el-input v-model="role.name" placeholder="请求路径" />
        </el-form-item>
        <el-form-item label="请求方式">
          <el-input v-model="role.name" placeholder="请求方式" />
        </el-form-item>
      </el-form>
