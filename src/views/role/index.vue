<template>
  <div class="app-container">
    ...
    <el-table :data="rolesList" style="width: 100%;margin-top:30px;" border>
      <el-table-column label="角色唯一标识" prop="id" sortable="custom" align="center" width="80">
...
import { getRoutes, getRoles, addRole, deleteRole, updateRole, changeAuth } from '@/api/role'
...
export default {
  ...
  methods: {
    ...
    async getRoles(listQuery) {
      const res = await getRoles(listQuery)
